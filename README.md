...
<p align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,react,nextjs,nodejs,express,mongodb,postgres,graphql,tailwind,docker,aws,py,java,vue,linux,git,postman,figma,photoshop,vite,supabase,prisma,tensorflow,nginx,anaconda,firebase,gcp,azure,appwrite" />
</p>
